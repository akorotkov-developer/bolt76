...
?>
<button type="button" data-toggle="dropdown" data-loading-text="Loading..." class="btn-header-cart">
    <img src="<?= SITE_TEMPLATE_PATH?>/images/cart.svg">
    <?php if ($cart_num == 0) { ?>
        <span id="cart-total"><span class="basket-text">Корзина</span> (0)</span>
    <?php } else {?>
        <span id="cart-total"><span class="basket-text">Корзина</span> (<?= $cart_num ?>)</span>
    <?php }?>
</button>
<?php if ($cart_num > 0) { ?>
        ...
        <li>
            <div class="cart_bottom">
                <table class="minicart_total">
                    <tr>
                        <td class="text-left minicart_total-title"><span>Сумма</span>
                        </td>
                        <td class="text-right minicart_total-value" id="minicart_sum"><?= $cart_sum ?> ₽</td>
                    </tr>
                    <tr>
                        <td class="text-left minicart_total-title"><span>Товара(ов)</span>
                        </td>
                        <td class="text-right minicart_total-value" id="minicart_total"><?= $cart_num ?></td>
                    </tr>
                </table>
                <div class="buttons">
                    <span class="cart_bt"><a href="/personal/cart/" class="btn">В корзину</a></span>
                    <span class="checkout_bt"><a class="btn btn-shopping btn-clearbasket" href="?clear_basket=Y">Очистить</a></span>
                </div>
            </div>
        </li>
    </ul>
    ...
    <style>
        ...
        .basket-items-list-wrapper-custom.basket-items-list-wrapper {
            border: 0px;
        }
        ...
        .basket-items-list-item-price-custom {
            position: absolute;
            top: 48px;
            left: 178px;
        }
        .basket-items-list-item-price-custom span.basket-item-price-current-text {
            order: 1;
        ...
        .basket-items-list-item-price-hide {
            display: none;
        }
        .basket-item-block-properties-custom {
            display: none;
        }
        .basket-item-info-name-link {
        ...
        .basket-items-list-custom {
            padding: 0px;
        }
        .basket-items-list-item-descriptions-custom {
            padding-top: 0px;
        }
        .basket-item-info-name-link {
            padding: 0px;
