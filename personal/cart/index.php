...
$APPLICATION->IncludeComponent(
	...
	[
		...
		"COLUMNS_LIST_EXT" => array("PREVIEW_PICTURE","DISCOUNT","DELETE","DELAY","TYPE","SUM", "PROPERTY_ARTICUL"),
		"COLUMNS_LIST_MOBILE" => array("PREVIEW_PICTURE","DISCOUNT","DELETE","DELAY","TYPE","SUM", "PROPERTY_ARTICUL"),
		"COMPATIBLE_MODE" => "Y",
		"CORRECT_RATIO" => "Y",
