...
<div class="product-item">
    <div class="b-favorite">
        <svg data-product-id="<?= $arResult['ITEM']['ID']?>" class="favorite-svg-icon active" title="Добавить в избранное" width="31" height="31" viewBox="0 0 24 24" fill="none" stroke="#8899a4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
