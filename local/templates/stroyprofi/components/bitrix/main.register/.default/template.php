...
<table>
	<tbody>
		<tr>
			...
			<td><input class="form-control" size="30" type="text" name="SMS_CODE" value="<?=htmlspecialcharsbx($arResult["SMS_CODE"])?>" autocomplete="off" /></td>
		</tr>
	</tbody>
	<tfoot>
		<tr>
			<td></td>
			<td><input class="btn btn-primary" type="submit" name="code_submit_button" value="<?echo GetMessage("main_register_sms_send")?>" /></td>
		</tr>
	</tfoot>
</table>
</form>
...
<?
		...
		case "PERSONAL_PHOTO":
		case "WORK_LOGO":
			?><input class="form-control-file" size="30" type="file" name="REGISTER_FILES_<?=$FIELD?>" /><?
			break;
...
if ($arResult["USE_CAPTCHA"] == "Y")
{
	?>
		...
		<tr>
			...
			<td><input class="form-control" type="text" name="captcha_word" maxlength="50" value="" autocomplete="off" /></td>
		</tr>
	<?
}
/* !CAPTCHA */
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td><input type="submit" class="btn btn-primary" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
</form>
