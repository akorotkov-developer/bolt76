...
if (sizeof($arResult["ITEMS"]) > 0) {
    ...
    <? foreach ($arResult["ITEMS"] as $cell => $arElement): ?>
        ...
        <tr id="<?= $this->GetEditAreaId($arElement['ID']); ?>"
            ...
            <td class="nopadding-i">
                <? if ($arElement["DETAIL_TEXT"]) { ?><a href="#" class="fancybox_detailed"
                                                         data-id="detailed_text_<?= $arElement["ID"] ?>">
                ...
                <div class="buy_helper_holder">
                    ...
                    <div class="buy_helper">
                        ...
                        <? if (count($countTips)) { ?>
                            <div class="help_values">
                                <? foreach ($countTips as $c) { ?>
                                    <a href="#" data-val="<?= $c ?>">+<span><?= $c ?> <?= $mera; ?></span></a>
                                <? } ?>
                                <div class="clear"></div>
                            </div>
                        <? } ?>
    ...
    <div class="order">
        <div class="order_button">
            <a href="/cart/" onclick="$(this).closest('form').submit(); return false; " class="link_like_button">В
                корзину</a>
        </div>
