...
<p><span style="width: 20px; text-align: center; display: inline-block;">&larr;</span> <a href="<?=$arResult["SECTION"]["SECTION_PAGE_URL"];?>">Вернуться в оглавление</a></p>
<?}?>
...
?>
<p><span style="width: 20px; text-align: center; display: inline-block;">&uarr;</span> <a href="#top">В начало страницы</a></p>
<?if($arResult["SECTION"]["SECTION_PAGE_URL"]){?>
    <p><span style="width: 20px; text-align: center; display: inline-block;">&larr;</span> <a href="<?=$arResult["SECTION"]["SECTION_PAGE_URL"];?>">Вернуться в оглавление</a></p>
<?}?>
