    ...
    <? if ($arResult["FORM_TYPE"] == "login"): ?>
        ...
        <form name="system_auth_form<?= $arResult["RND"] ?>" class="form-container" method="post" target="_top"
            ...
            <div class="form-group">
                <input type="text" placeholder="Введите Логин" class="form-control" id="login" name="USER_LOGIN" maxlength="50" value="" size="17"/>
            </div>
            <script>
                BX.ready(function () {
            ...
            <input type="password" class="form-control" placeholder="Введите Пароль" name="USER_PASSWORD" maxlength="255" size="17" autocomplete="off"/>
