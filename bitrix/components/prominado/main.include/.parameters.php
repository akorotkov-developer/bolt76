...
$arComponentParameters["PARAMETERS"]["THANKS"] = array(
	"NAME" => "Слова благодарности",
	"TYPE" => "STRING",
	"MULTIPLE" => "N",
	"ADDITIONAL_VALUES" => "N",
	"PARENT" => "PARAMS",
	"DEFAULT" => "Благодарим вас за заказ!<br/>В ближайшее время мы свяжемся с вами."
);
$arComponentParameters["PARAMETERS"]["EMPTY"] = array(
	"NAME" => "Пустая корзина",
	"TYPE" => "STRING",
	"MULTIPLE" => "N",
	"ADDITIONAL_VALUES" => "N",
	"PARENT" => "PARAMS",
	"DEFAULT" => "Ваша корзина сейчас пуста. Перейти в <a href='/catalog/'>каталог</a>"
);
?>